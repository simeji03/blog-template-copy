jQuery(function () {
  ...
  jQuery(".js-file").change(function () {
    jQuery(this).siblings(".c-file__result").show();
    jQuery(this).siblings(".c-file__result").text(jQuery(this).val());
  });
  ...
  jQuery(".js-drawer-close a").on("click", function (e) {
    e.preventDefault();
    jQuery(this).parents(".js-drawer-close").parent().toggleClass("is-checked");
    return false;
  });
  ...
  jQuery(".js-accordion").on("click", function (e) {
    e.preventDefault();
    jQuery(this).siblings(".js-accordion-content").slideToggle(500);
    jQuery(this).parent(".c-accordion").toggleClass("is-checked");
    return false;
  });
  ...
  jQuery(".js-tab").on("click", function (e) {
    e.preventDefault();
    jQuery(this).parent().children().removeClass("is-checked");
  ...
  let parallaxItemObserver = new IntersectionObserver(function (
    entries,
    observer
  ) {
